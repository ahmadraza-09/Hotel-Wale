    ...
    return (
        <div className="bg-white dark:bg-gray-900 text-black dark:text-white transition-colors">
            <div className="sm:p-6 font-TTHovesMedium p-0">
                <div className="max-w-9xl w-full mx-auto bg-gray-100 dark:bg-gray-800 rounded-2xl px-5 py-5 transition-colors">
                    {/* Header */}
                    ...
                    <div className="flex justify-around sm:justify-start sm:gap-10 mb-6 py-5">
                        ...
                        <div className="flex flex-col gap-2 justify-center items-center">
                            <button className={`w-[52px] h-[52px] py-2 px-4 rounded-md shadow-custom ${isActive("/hotel") ? "bg-myColor text-white" : "bg-white dark:bg-gray-900 text-gray-800 dark:text-white"
                    ...
                    {/* Search Form */}
                    <div className="bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-lg shadow-custom transition-colors">
                        <form className="flex flex-col md:flex-row gap-4">
                            {/* Destination Input */}
                            <div className="flex-grow">
                                <label className="block text-gray-600 dark:text-gray-300 font-medium mb-2">Destination</label>
                                <input
                                    type="text"
                                    placeholder="Nainital, Uttarakhand, India"
                                    className="w-full border border-gray-300 dark:border-gray-700 rounded-md p-3 focus:ring-2 focus:ring-orange-500 bg-white dark:bg-gray-800 text-black dark:text-white"
                                />
                            </div>
                            ...
                            {/* Guests Input */}
                            <div>
                                <label className="block text-gray-600 dark:text-gray-300 font-medium mb-2">Guests</label>
                                <input
                                    type="text"
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="p-4 border border-gray-300 dark:border-gray-700 rounded-md">
                                <p className="text-gray-600 dark:text-gray-300">Recent Search 1</p>
                            </div>
                            <div className="p-4 border border-gray-300 dark:border-gray-700 rounded-md">
                                <p className="text-gray-600 dark:text-gray-300">Recent Search 2</p>
                            </div>
                        </div>
                    </div>
                </div>

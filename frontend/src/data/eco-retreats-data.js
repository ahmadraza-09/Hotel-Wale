...
const ecoRetreatData = {
  ...
  putsil: {
    ...
    rooms: [
      {
        name: "Deluxe Swiss Cottage",
        images: [PutsilDeluxeSwissCottage],
        facilities: [
          "Air Conditioning",
          "WiFi",
          "King-Size Bed",
      ...
      {
        name: "Premium Swiss Cottage",
        images: [PutsilPremiumSwissCottage],
        facilities: [
          "Private Patio",
          "24x7 Assistance",
          "Spacious Interiors",
    ...
    cottages: [
      { exploreImages: PutsilExploreImg }, // This is the first element, used only for the explore image
      {
        name: "Deluxe Swiss Cottage",
        icon: DeluxeSwissCottageIcon,
        description: "With a comfortable twin / double bed along with a spacious porch and attached bathroom.",
    ...
    topAttractions: [
      {
        name: "Sabar Srikhetra",
        image: SabarSrikhetra
      },
      {
        name: "Tribal Museum",
        image: TribalMuseum
  ...
  sonapur: {
    ...
    rooms: [
      {
        name: "Deluxe Swiss Cottage",
        images: [SonapurDeluxeSwissCottage],
        facilities: [
          "Air Conditioning",
          "WiFi",
          "King-Size Bed",
      ...
      {
        name: "Premium Swiss Cottage",
        images: [SonapurPremiumSwissCottage],
        facilities: [
          "Private Patio",
          "24x7 Assistance",
          "Spacious Interiors",
    ...
    cottages: [
      { exploreImages: SonapurExploreImg }, // This is the first element, used only for the explore image
      {
        name: "Deluxe Swiss Cottage",
        icon: DeluxeSwissCottageIcon,
        description: "With a comfortable twin / double bed along with a spacious porch and attached bathroom.",
    ...
    howToReach: {
      ...
      byRail: [
        {
          station: "Berhampur Station",
          distance: "25 kms",
          time: "45 mins",
        },
        {
          station: "Ichchapuram Station",
          distance: "18 kms",
          time: "35 mins",
        },
      ],
    ...
    topAttractions: [
      {
        name: "Sureswari Temple",
        image: SureswariTemple
      },
      {
        name: "Lankeswari Temple",
        image: LankeswariTemple
      },
      {
        name: "Subarnameru Shiva Temple",
        image: SubarnameruShivaTemple
      },
    ],
  },
  daringbadi: {
    ...
    rooms: [
      {
        name: "Deluxe Swiss Cottage",
        images: [DaringbadiDeluxeSwissCottage],
        facilities: [
          "Air Conditioning",
          "WiFi",
          "King-Size Bed",
      ...
      {
        name: "Premium Swiss Cottage",
        images: [DaringbadiPremiumSwissCottage],
        facilities: [
          "Private Patio",
          "24x7 Assistance",
          "Spacious Interiors",
    ...
    cottages: [
      { exploreImages: DaringbadiExploreImg }, // This is the first element, used only for the explore image
      {
        name: "Deluxe Swiss Cottage",
        icon: DeluxeSwissCottageIcon,
        description: "With a comfortable twin / double bed along with a spacious porch and attached bathroom.",
  ...
  hirakud: {
    ...
    rooms: [
      {
        name: "Premium Swiss Cottage",
        images: [HirakudPremiumSwissCottage],
        facilities: [
          "Private Patio",
          "24x7 Assistance",
          "Spacious Interiors",
    ...
    cottages: [
      { exploreImages: HirakudExploreImg }, // This is the first element, used only for the explore image
      {
        name: "Premium Swiss Tent",
        icon: PremiumSwissCottageIcon,
        description: "Comfortable twin / double bed with a spacious sitting space to relax and en suite bathroom.",
    ...
    howToReach: {
      ...
      byRail: [
        {
          station: "Sambalpur Railway Station",
          distance: "16 kms",
          time: "30 mins",
        },
    ...
    topAttractions: [
      ...
      },
      {
        ...
        image: DebrigarhWildlifeSanctuary
      },
      {
        name: "Maa Samaleswari Temple",
        image: MaaSamaleswariTemple
      },
    ],
  },
  bhitarkanika: {
    ...
    rooms: [
      {
        name: "Deluxe Swiss Cottage",
        images: [BhitarkanikaDeluxeSwissCottage],
        facilities: [
          "Air Conditioning",
          "WiFi",
          "King-Size Bed",
      ...
      {
        name: "Premium Swiss Cottage",
        images: [BhitarkanikaPremiumSwissCottage],
        facilities: [
          "Private Patio",
          "24x7 Assistance",
          "Spacious Interiors",
    ...
    cottages: [
      { exploreImages: BhitarkanikaExploreImg }, // This is the first element, used only for the explore image
      {
        name: "Deluxe Swiss Cottage",
        icon: DeluxeSwissCottageIcon,
        description: "With a comfortable twin / double bed along with a spacious porch and attached bathroom.",
    ...
    howToReach: {
      ...
      byRail: [
        {
          station: "Kendrapara Railway Station",
          distance: "48 kms",
          time: "1 hrs 45 mins",
        },
        {
      ...
      byRoad: [
        ...
        {
          city: "Jamshedpur (Via Baripada, Balasore)",
          distance: "375 kms",
          time: "8 hrs",
        },
        {
    ...
    topAttractions: [
      {
        ...
        image: BhitarkanikaNationalPark
      },
      {
        name: "Boating In The Creek",
        image: BoatingInTheCreek
      },
      {
        name: "Barunei Forest",
        image: BaruneiForest

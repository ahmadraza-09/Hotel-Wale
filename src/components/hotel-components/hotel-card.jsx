        ...
        >
            ...
            <div className="p-2 font-TTHovesRegular">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex mt-2">
                        <span className="flex gap-[5px] px-2 py-1 bg-green-100 text-green-700 rounded-md text-sm font-medium">
                            <img src={Star} alt="" className="w-4" />{hotel.rating}
                        </span>
                    </div>
                </div>
                <div className="flex justify-between items-center">
                ...
                <p className="text-xl font-bold text-gray-800">
                    ₹{hotel.pricePerNight}{" "}
                    <span className="text-sm text-gray-500">+ ₹{hotel.taxesAndFees} taxes & fees / night</span>
                </p>

                <div className="flex flex-wrap gap-2 mt-4">
                    {hotel.amenities.map((amenity, index) => (
                        <div key={index} className="flex items-center gap-1 bg-gray-100 px-3 py-1 rounded-full shadow-sm">
